...
export default function ExploreSection() {
  return (
    <section className="w-full font-sans">
      ...
      <div className="w-full bg-slate-950 border-y border-slate-800 text-slate-300 py-3.5 px-4 overflow-x-auto">
        <div className="max-w-7xl mx-auto flex items-center justify-between min-w-[700px] gap-6 text-xs font-semibold tracking-wider uppercase">
          <div className="flex items-center gap-2 hover:text-emerald-400 transition cursor-default">
      ...
      <div className="relative w-full bg-slate-50 py-16 px-4 md:px-8 overflow-hidden border-b border-slate-200">
        {/* Abstract Light Circuit Grid Overlay (Factory/Tech Theme) */}
        <div 
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          <div className="inline-block px-3 py-1 bg-emerald-100 text-emerald-800 text-[11px] font-extrabold uppercase tracking-widest rounded-full">
